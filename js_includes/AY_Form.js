    ...
    _init: function () {
        ...
        function handleClick(dom) {
            return function (e) {
                ...
                rlines.push([["Field name", "clozeGuess"],
                                 ["Field value", t.cloze]]);
        ...
        var dom = htmlCodeToDOM(this.html, function (dom) {
            ...
            if (t.continueOnReturn) {
                t.safeBind($(dom).find("input[type=text]"), 'keydown', function (e) { if (e.keyCode == 27) {t.cloze = document.getElementById("datatosend").value; console.log("H"); return handler(e);} });
